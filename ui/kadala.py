...
#    Apr 25, 2022 01:33:56 AM CEST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, kadala_support, top=None):
        ...
        self.label_r1.place(x=5, y=17, height=21, width=85, bordermode='ignore')
        ...
        self.label_r1_tooltip = \
        ToolTip(self.label_r1, self.tooltip_font, '''this is a test''')
        ...
        self.label_shield.place(x=5, y=17, height=21, width=85
                , bordermode='ignore')
        ...
        self.label_amulet.place(x=5, y=17, height=21, width=85
                , bordermode='ignore')
        ...
        self.label_r2.place(x=5, y=17, height=21, width=85, bordermode='ignore')
        ...
        self.label_mod.place(x=5, y=17, height=21, width=85, bordermode='ignore')
        ...
        self.label_spell.place(x=5, y=17, height=21, width=85
                , bordermode='ignore')
        ...
        self.button_browse.place(x=380, y=10, height=34, width=243)
        ...
        self.button_browse.configure(command=kadala_support.load_save)
