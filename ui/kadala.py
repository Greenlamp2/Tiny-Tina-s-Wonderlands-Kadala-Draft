...
#    Apr 24, 2022 10:50:25 PM CEST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, kadala_support, top=None):
        ...
        self.Button3.configure(command=kadala_support.transfer)
        ...
        self.Entry1_1.configure(textvariable=self.text_name)
        ...
        self.Entry1_1_1.configure(textvariable=self.text_name)
        ...
        self.Button3_2.configure(command=kadala_support.transfer)
