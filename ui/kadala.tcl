...
proc vTclWindow.top1 {base} {
    ...
    wm deiconify $top
    set toptitle "Tiny Tina's Wonderlands - Clone enchantment"
    ...
    place $site_4_0.but71 \
        -in $site_4_0 -x 90 -y 30 -width 42 -height 24 -anchor nw \
        -bordermode ignore 
    ...
    place $site_4_0.but76 \
        -in $site_4_0 -x 30 -y 30 -width 42 -height 24 -anchor nw \
        -bordermode ignore 
    ...
    place $site_3_0.but46 \
        -in $site_3_0 -x 200 -y 30 -anchor nw -bordermode ignore 
    labelframe $top.lab67 \
        -font TkDefaultFont -foreground black -text To \
        -background $vTcl(actual_gui_bg) -height 75 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 260 
    vTcl:DefineAlias "$top.lab67" "Labelframe5_1" vTcl:WidgetProc "Toplevel1" 1
    ...
    label $site_3_0.lab83 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text None 
    vTcl:DefineAlias "$site_3_0.lab83" "label_to" vTcl:WidgetProc "Toplevel1" 1
    button $site_3_0.but47 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command del_to -compound left \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -state disabled -text Clear 
    vTcl:DefineAlias "$site_3_0.but47" "Button1_1" vTcl:WidgetProc "Toplevel1" 1
    place $site_3_0.lab83 \
        -in $site_3_0 -x 20 -y 30 -width 164 -height 21 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but47 \
        -in $site_3_0 -x 200 -y 30 -width 38 -height 24 -anchor nw \
        -bordermode ignore 
    button $top.but68 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command transfer -compound left \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -state disabled -text {Clone enchantment} 
    ...
    place $top.lab66 \
        -in $top -x 380 -y 10 -width 261 -relwidth 0 -height 75 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab67 \
        -in $top -x 380 -y 90 -width 261 -relwidth 0 -height 75 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but68 \
        -in $top -x 390 -y 180 -width 243 -relwidth 0 -height 34 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but49 \
        -in $top -x 390 -y 220 -width 243 -relwidth 0 -height 34 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab50 \
        -in $top -x 390 -y 260 -width 240 -relwidth 0 -height 55 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab46 \
        -in $top -x 480 -y 320 -anchor nw -bordermode ignore 
