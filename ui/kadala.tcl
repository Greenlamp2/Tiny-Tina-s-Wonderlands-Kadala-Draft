...
#  Apr 25, 2022 01:29:35 AM CEST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    bind $site_4_0.lab51 <<SetBalloon>> {
        set ::vTcl::balloon::%W {this is a test}
    }
    place $site_4_0.but76 \
        -in $site_4_0 -x 30 -y 40 -width 42 -height 24 -anchor nw \
        -bordermode ignore 
    place $site_4_0.lab51 \
        -in $site_4_0 -x 5 -y 17 -width 85 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    vTcl:DefineAlias "$top.but68" "button_gamble" vTcl:WidgetProc "Toplevel1" 1
    button $top.but49 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
    ...
    vTcl:DefineAlias "$top.but54" "button_save_to" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab49 \
        -activebackground #f9f9f9 -activeforeground black -anchor w \
        -background $vTcl(actual_gui_bg) -compound left \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
